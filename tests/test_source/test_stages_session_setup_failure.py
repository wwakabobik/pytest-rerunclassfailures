"""This module contains a session-scope fixture that always fails during setup.
...
class TestFailInSessionSetup:  # pylint: disable=too-few-public-methods
    """This test checks that a failing session-scope fixture never crashes the plugin"""

    def test_after_session_setup(self):
        """This test should never run, the session fixture always fails"""
        assert True
