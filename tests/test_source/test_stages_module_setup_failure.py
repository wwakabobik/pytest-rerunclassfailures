"""This module contains a module-scope fixture that always fails during setup.
...
class TestFailInModuleSetup:  # pylint: disable=too-few-public-methods
    """This test checks that a failing module-scope fixture never crashes the plugin"""

    def test_after_module_setup(self):
        """This test should never run, the module fixture always fails"""
        assert True
